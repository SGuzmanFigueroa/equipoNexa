  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          role="menu"
          className={`absolute z-50 mt-2 w-72 max-sm:fixed max-sm:inset-x-4 max-sm:top-16 max-sm:mt-0 max-sm:w-auto rounded-lg border border-slate-200 bg-white p-2 shadow-xl dark:border-slate-700 dark:bg-slate-800 ${
                ...
                <li key={app.id}>
                  <a
                    ...
                    className={`flex items-center gap-3 rounded-md px-2 py-2 transition-colors ${
                      current
                        ? "bg-nexa-light dark:bg-blue-950/40"
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      ...
                      <span className="block text-xs text-slate-500 dark:text-slate-400">{app.description}</span>
                    </span>
                    {current && (
